...
public abstract class Templator {
	...
	abstract class Templator$Templated {
		...
		Map<String, Object> getValuesMapFromArray(final Object[] values) {
			...
			final Map<String, Object> _values = new HashMap<String, Object>() ;
			for ( Integer i = 1; (i <= values.length); i++ )
				_values.put(i.toString(), values[i - 1]) ;
	...
	public class Templator$TemplatedAsStringBuilder extends Templator$Templated {
		...
		public StringBuilder inject(final boolean asArray, final Object... values) {
			return Template.replaceTags(template, delimited.delimiters(), getValuesMapFromArray(values)) ;
		}
		...
		public StringBuilder inject(final List<Object> values) {
			return Template.replaceTags(template, delimited.delimiters(), getValuesMapFromList(values)) ;
		}
		...
		public StringBuilder inject(final Map<String, Object> values) {
			return Template.replaceTags(template, delimited.delimiters(), values) ;
		}


		@Log
		public StringBuilder injectRepeating(final ArrayList<Map<String, Object>> repeatValues) {
			return Template.replaceRepeatedTags(template, delimited.tagDelimiters(), delimited.repeatingDelimiters(), repeatValues) ;
		}
	}
	...
	public class Templator$TemplatedAsString extends Templator$Templated {
		 ...
		 */
		@Log
		public String inject(final boolean asArray, final Object... values) {
			return Template.replaceTags(new StringBuilder(template), delimited.delimiters(), getValuesMapFromArray(values)).toString() ;
		}
		...
		public String inject(final List<Object> values) {
			return Template.replaceTags(new StringBuilder(template), delimited.delimiters(), getValuesMapFromList(values)).toString() ;
		}
		...
		public String inject(final Map<String, Object> values) {
			return Template.replaceTags(new StringBuilder(template), delimited.delimiters(), values).toString() ;
		}


		@Log
		public String injectRepeating(final ArrayList<Map<String, Object>> repeatValues) {
			return Template.replaceRepeatedTags(new StringBuilder(template), delimited.tagDelimiters(), delimited.repeatingDelimiters(), repeatValues)
					.toString() ;
		}
	}
