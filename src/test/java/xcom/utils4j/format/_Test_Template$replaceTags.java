...
public class _Test_Template$replaceTags {
	 ...
	 * @param expected
	 */
	public _Test_Template$replaceTags(final Object[] template, final Object[] delimiters, final Object[] values, final Object[] expected) {
	...
	public void replaceTags_FromString() {
		...
		try {
			...
			final String actual = Template.replaceTags(new StringBuilder(template), delimiters, values).toString() ;
