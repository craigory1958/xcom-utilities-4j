...
public class _Test_Query$Mapped<K, V> {
	...
	public void constructor_Query$$Mapped_Initialization() {
		...
		final Query$Mapped<String, String> mapped = new Query() {}.new Query$Mapped<String, String>(stated, rowMapper) ;
	...
	public void method_getResultSetAsList_Returns_Data() throws SQLException {
		...
		final Query$Mapped<String, String> mapped = new Query() {}.new Query$Mapped<String, String>(
				new Query() {}.new Query$Stated(connected, TestQuery_Statement), new RowMapper_ToMap(new ColumnMapper_FromMySQL())) ;
	...
	public void method_getResultSetAsList_ThrowsOn_Connection$$CreateStatement() throws SQLException {
		...
		new Query() {}.new Query$Mapped<String, String>(new Query() {}.new Query$Stated(connected, TestQuery_StatementWhereClause),
