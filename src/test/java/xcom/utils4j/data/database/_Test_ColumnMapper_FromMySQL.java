...
public class _Test_ColumnMapper_FromMySQL {
	...
	public void method_mapColumn_Retures_ValidString() throws SQLException {
		...
		Mockito.when(rs.getString(Mockito.anyInt())).thenReturn(TestQuery_KeyValue_15000) ;

		final ColumnMapper_FromMySQL columnMapper = new ColumnMapper_FromMySQL() ;
		Assert.assertEquals("Incorrect value for method 'mapColumn':", TestQuery_KeyValue_15000, columnMapper.mapColumn(rs, 1)) ;
	}
