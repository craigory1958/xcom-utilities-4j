...
public class _Test_Query$Stated {
	...
	public void method_execute_Returns_ValidData() throws SQLException {
		...
		Assert.assertEquals("Incorrect value returned from method 'getResult()':", true, status.getResult()) ;
		Assert.assertEquals("Incorrect value returned from method 'getNumberOfAffectedRows()':", 1, status.getNumberOfAffectedRows()) ;
	}
