 ...
 *
 * <pre>
 * List&lt;Map&lt;K, V>> = Query .connection(connection) .statement(statement) [ .inject(values) ] .mapTo(rowMapper&lt;K, V>()) .getResultSetAsList()
 * </pre>
 *
 * </li>
 *
 ...
 *
 * <pre>
 * Query.Status = Query .connection(connection) .statement(statement) [ .inject() ] .execute()
 * </pre>
 *
 * </li>
 *
 ...
 *
 * <pre>
 * ResultSetMetaData = Query .connection(connection) .statement(statement) [ .inject() ] .getResultSetMetaData()
 * </pre>
 *
 * </li>
 *
 ...
 *
 * <pre>
 * DatabaseMetaData = Query .connection(connection) .getDatabaseMetaData()
 *
 * Boolean = Query .connection(connection) .tableExists()
 * </pre>
 *
 * </li>
 * </ul>
...
public abstract class Query {
	...
	public class Query$Connected {
		 ...
		 * @return an instantiated <code>Query$Stated</code> object
		 */
		@Log
	 ...
	 *
	 * <p>
	 * A 'mapped' Query object has a row mapper to convert a SQL result set to the requested return type.
	 * </p>
	 *
	 * @param <T>
	 ...
	 *
	 * <p>
	 * A 'stated' Query object has an SQL statement and optional parameters.
	 * </p>
	 */
	public class Query$Stated {
		...
		*/
		...
		/**
		 * Instantiate the Query$Stated object.
		 *
		 * @param connected
		 *
		 * @param statement
		 ...
		 * @return - the <code>Query$Stated</code> object
		 */
		@Log
		 ...
		 * @return an instantiated <code>Query$Mapped</code> object
		 */
		@Log
		public <K, V> Query$Mapped<K, V> mapTo(final iRowMapper<K, V> rowMapper) {
			return new Query$Mapped<>(this, rowMapper) ;
		}
	}
	 ...
	 * @return an instantiated <code>Query$NonStated</code> object
	 */
	@Log
