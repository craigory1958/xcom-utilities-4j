...
public class Logging {
	 ...
	 */
	@Before("execution(@xcom.utils4j.logging.aspects.api.annotations.Log * *(..))")
	 ...
	 */
	@AfterReturning(pointcut = "execution(@xcom.utils4j.logging.aspects.api.annotations.Log * *(..))", returning = "returned")
	 ...
	 *            - Contains method data
	 */
	@Before("execution(@xcom.utils4j.logging.aspects.api.annotations.Log *.new(..))")
	 ...
	 *            - Contains method data
	 */
	@AfterReturning(pointcut = "execution(@xcom.utils4j.logging.aspects.api.annotations.Log *.new(..))")
