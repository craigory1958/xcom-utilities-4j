...
import static xcom.utils4j.data.Excels.ABSOLUTE_COLUMN_REFERENCE ;
...
public class _Test_Excels$cellRef {
	...
	public static Collection<Object[][]> data() {
		...
		final int MaxColumns = (short) (Excels.COLUMN_NAMES.length() / 3) - 1 ;
        ...
        final Object[][][] results = {
                ...
                { { 0, MaxColumns +1, new IllegalArgumentException() }, {} },
                { { 0, MaxColumns +1, new IllegalArgumentException() }, { RELATIVE_REFERENCE } },
                { { 0, MaxColumns +1, new IllegalArgumentException() }, { RELATIVE_REFERENCE, RELATIVE_REFERENCE } },
        } ;
        //@formatter:on
