 ...
 */
@Log
@AColumnarDataReader(sourceType = { "XLS", "XLSX" })
public class ColumnarDataReader_Excel extends xcom.utils4j.data.columnar.ColumnarDataReader {
	 ...
	 * @throws IOException
	 */
	public ColumnarDataReader_Excel(final File file, final ColumnNamePolicyTypes columnNamePolicy) throws InvalidFormatException, IOException {
		this(file, 0, columnNamePolicy) ;
	}
	 ...
	 * @throws IOException
	 */
	public ColumnarDataReader_Excel(final File file, final int sheetIndex, final ColumnNamePolicyTypes columnNamePolicy) throws InvalidFormatException, IOException {
	 ...
	 * @throws IOException
	 */
	public ColumnarDataReader_Excel(final URL resource, final ColumnNamePolicyTypes columnNamePolicy) throws InvalidFormatException, IOException {
		this(resource, 0, columnNamePolicy) ;
	}
	 ...
	 * @throws IOException
	 */
	public ColumnarDataReader_Excel(final URL resource, final int sheetIndex, final ColumnNamePolicyTypes columnNamePolicy) throws InvalidFormatException, IOException {
	...
	void initialize(final InputStream stream) throws InvalidFormatException, IOException {
		...
		for ( int colNum = 0; (colNum < colMax); colNum++ ) {
			...
			if ( columnNamePolicy==SimpleColumnNamePolicy )
	...
	String normalizedColumnName(final String columnName) {
		return (columnNamePolicy==ExactColumnNamePolicy ? columnName : columnName.toLowerCase()) ;
	}
}
