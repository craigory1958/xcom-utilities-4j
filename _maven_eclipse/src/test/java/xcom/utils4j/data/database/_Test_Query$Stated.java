...
import static xcom.utils4j.data.database.TestQuerys.TestQuerys_Parms ;
...
public class _Test_Query$Stated {
	...
	public void constructor_Query$$Stated_Initialization() {
		...
		final Query$Stated stated = new Query() {}.new Query$Stated(connected, TestQuerys_StatementWhereClause) ;
		Assert.assertEquals("Incorrect value for member 'connected':", connected, stated.connected) ;
		Assert.assertEquals("Incorrect value for member 'statement':", TestQuerys_StatementWhereClause, stated.statement) ;
		Assert.assertEquals("Incorrect value for member '_statement':", TestQuerys_StatementWhereClause, stated._statement) ;
	}
	...
	public void method_getStatement_Returns_ValidData() {
		...
		final Query$Stated stated = new Query() {}.new Query$Stated(null, TestQuerys_StatementWhereClause) ;
		Assert.assertEquals("Incorrect value for  method 'getStatement()':", TestQuerys_StatementWhereClause, stated.getStatement()) ;
	}
	...
	public void method_inject_Returns_InjectedParameters() {
		...
		final Query$Stated stated = new Query() {}.new Query$Stated(null, TestQuerys_StatementWhereClause) ;
		Assert.assertEquals("Method inject() did not inject parameters;", TestQuerys_InjectedStatementWhereClause,
				stated.inject(TestQuerys_Parms).getStatement()) ;
	}
	...
	public void method_execute_Returns_ValidData() throws SQLException {
		...
		final Status status = new Query() {}.new Query$Stated(connected, TestQuerys_Statement).execute() ;
	...
	public void method_execute_ThrowsOn_Connecion$$createStatement() throws SQLException {
		...
		new Query() {}.new Query$Stated(connected, TestQuerys_Statement).execute() ;
	}
	...
	public void method_getResultSetMetaData_Returns_Data() throws SQLException {
		...
		Assert.assertNotNull("Method 'getResultSetMetaData()' did not return data.",
				new Query() {}.new Query$Stated(connected, TestQuerys_Statement).getResultSetMetaData()) ;
	}
